...
public class ManageCustomersFormController {
    ...
    private CustomerBo customerBo = (CustomerBo) BoFactory.getBoFactory().getBo(BoFactory.DataType.CUSTOMER_BO);
    ...
    private void loadAllCustomers() {
        ...
        /*Get all customers*/
        try {
           ArrayList<CustomerDTO> allCustomer = customerBo.loadAllCustomers();
